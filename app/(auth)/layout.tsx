        ...
        <main className="auth-layout">
            <section className="auth-left-section scrollbar-hide-default">
                <Link href="/" className="auth-logo">
                    <Image src="/assets/icons/logo.svg" alt="Stock Market" width={140} height={32} className='h-8 w-auto' />
            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg:mt-4 lg:mb-16">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <cite className="auth-testimonial-author">Deepak Sahani </cite>
                            <p className="max-md:text-xs text-green-500"> Option Trader</p>
                        </div>
